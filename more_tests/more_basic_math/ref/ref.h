...
riscv_status ref_conv_partial_f32(
  float32_t * pSrcA,
  uint32_t srcALen,
  float32_t * pSrcB,
  uint32_t srcBLen,
...
riscv_status ref_conv_partial_q31(
  q31_t * pSrcA,
  uint32_t srcALen,
  q31_t * pSrcB,
  uint32_t srcBLen,
...
riscv_status ref_conv_partial_fast_q31(
  q31_t * pSrcA,
  uint32_t srcALen,
  q31_t * pSrcB,
  uint32_t srcBLen,
...
riscv_status ref_conv_partial_q15(
  q15_t * pSrcA,
  uint32_t srcALen,
  q15_t * pSrcB,
  uint32_t srcBLen,
...
riscv_status ref_conv_partial_fast_q15(
  q15_t * pSrcA,
  uint32_t srcALen,
  q15_t * pSrcB,
  uint32_t srcBLen,
...
riscv_status ref_conv_partial_fast_opt_q15(
  q15_t * pSrcA,
  uint32_t srcALen,
  q15_t * pSrcB,
  uint32_t srcBLen,
...
riscv_status ref_conv_partial_q7(
  q7_t * pSrcA,
  uint32_t srcALen,
  q7_t * pSrcB,
  uint32_t srcBLen,
...
riscv_status ref_mat_scale_f32(
  const riscv_matrix_instance_f32 * pSrc,
  float32_t scale,
  riscv_matrix_instance_f32 * pDst);

riscv_status ref_mat_scale_q31(
  const riscv_matrix_instance_q31 * pSrc,
  q31_t scale,
  int32_t shift,
  riscv_matrix_instance_q31 * pDst);

riscv_status ref_mat_scale_q15(
  const riscv_matrix_instance_q15 * pSrc,
  q15_t scale,
  int32_t shift,
  riscv_matrix_instance_q15 * pDst);

riscv_status ref_mat_sub_f32(
  const riscv_matrix_instance_f32 * pSrcA,
  const riscv_matrix_instance_f32 * pSrcB,
  riscv_matrix_instance_f32 * pDst);

riscv_status ref_mat_sub_q31(
  const riscv_matrix_instance_q31 * pSrcA,
  const riscv_matrix_instance_q31 * pSrcB,
  riscv_matrix_instance_q31 * pDst);

riscv_status ref_mat_sub_q15(
  const riscv_matrix_instance_q15 * pSrcA,
  const riscv_matrix_instance_q15 * pSrcB,
  riscv_matrix_instance_q15 * pDst);

riscv_status ref_mat_trans_f64(
  const riscv_matrix_instance_f64 * pSrc,
  riscv_matrix_instance_f64 * pDst);

riscv_status ref_mat_trans_f32(
  const riscv_matrix_instance_f32 * pSrc,
  riscv_matrix_instance_f32 * pDst);

riscv_status ref_mat_trans_q31(
  const riscv_matrix_instance_q31 * pSrc,
  riscv_matrix_instance_q31 * pDst);

riscv_status ref_mat_trans_q15(
  const riscv_matrix_instance_q15 * pSrc,
  riscv_matrix_instance_q15 * pDst);

riscv_status ref_mat_add_f32(
  const riscv_matrix_instance_f32 * pSrcA,
  const riscv_matrix_instance_f32 * pSrcB,
  riscv_matrix_instance_f32 * pDst);

riscv_status ref_mat_add_q31(
  const riscv_matrix_instance_q31 * pSrcA,
  const riscv_matrix_instance_q31 * pSrcB,
  riscv_matrix_instance_q31 * pDst);

riscv_status ref_mat_add_q15(
  const riscv_matrix_instance_q15 * pSrcA,
  const riscv_matrix_instance_q15 * pSrcB,
  riscv_matrix_instance_q15 * pDst);
