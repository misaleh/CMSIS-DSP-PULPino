...
float32_t result_f32[RFFT_LEN] = {0};  
...
int32_t main(void)
{
 /*Init*/ 
  ...
  CLR_GPIO_6();
  /*rfft Init*/
  riscv_rfft_fast_init_f32(&S_rfft_f32 , RFFT_LEN);
/*Tests*/

/*rfft*/
  SET_GPIO_6();	
  riscv_rfft_fast_f32(&S_rfft_f32, testInput_f32,result_f32 ,ifftFlag);
  CLR_GPIO_6();	
#ifdef PRINT_OUTPUT
  PRINT_F32("riscv_rfft_fast_f32",result_f32,RFFT_LEN);
#endif
  printf("End\n");
 return 0;
}
