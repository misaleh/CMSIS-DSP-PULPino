...
/*Copy*/
  ...
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_F32("riscv_copy_f32",result_f32,MAX_BLOCKSIZE);
#endif
  SET_GPIO_5();
  riscv_copy_q7(src_buf_q7,result_q7, MAX_BLOCKSIZE);
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_copy_q7",result_q7,MAX_BLOCKSIZE);
#endif  
  SET_GPIO_6();
  riscv_copy_q15(src_buf_q15,result_q15, MAX_BLOCKSIZE);
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_copy_q15",result_q15,MAX_BLOCKSIZE);
#endif
  SET_GPIO_5();
  riscv_copy_q31(src_buf_q31,result_q31, MAX_BLOCKSIZE);
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_copy_q31",result_q31,MAX_BLOCKSIZE);
#endif
...
/*Fill*/
  ...
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_F32("riscv_fill_f32",result_f32,MAX_BLOCKSIZE);
#endif
  SET_GPIO_5();
  riscv_fill_q7(val_q7,result_q7, MAX_BLOCKSIZE);
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_fill_q7",result_q7,MAX_BLOCKSIZE);
#endif  
  SET_GPIO_6();
  riscv_fill_q15(val_q15,result_q15, MAX_BLOCKSIZE);
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_fill_q15",result_q15,MAX_BLOCKSIZE);
#endif
  SET_GPIO_5();
  riscv_fill_q31(val_q31,result_q31, MAX_BLOCKSIZE);
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_fill_q31",result_q31,MAX_BLOCKSIZE);
#endif
...
/*convert float*/
  ...
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_float_to_q15",result_q15,MAX_BLOCKSIZE);
#endif  
  SET_GPIO_6();
  riscv_float_to_q31(src_buf_f32,result_q31, MAX_BLOCKSIZE);
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_float_to_q31",result_q31,MAX_BLOCKSIZE);
#endif
...
/*convert q7*/
  ...
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_F32("riscv_q7_to_float",result_f32,MAX_BLOCKSIZE);
#endif
  SET_GPIO_6();
  riscv_q7_to_q15(src_buf_q7,result_q15, MAX_BLOCKSIZE);
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_q7_to_q15",result_q15,MAX_BLOCKSIZE);
#endif  
  SET_GPIO_5();
  riscv_q7_to_q31(src_buf_q7,result_q31, MAX_BLOCKSIZE);
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_q7_to_q31",result_q31,MAX_BLOCKSIZE);
#endif
...
/*convert q15*/
  ...
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_F32("riscv_q15_to_float",result_f32,MAX_BLOCKSIZE);
#endif
  SET_GPIO_5();
  riscv_q15_to_q7(src_buf_q15,result_q7, MAX_BLOCKSIZE);
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_q15_to_q7",result_q7,MAX_BLOCKSIZE);
#endif  
  SET_GPIO_6();
  riscv_q15_to_q31(src_buf_q15,result_q31, MAX_BLOCKSIZE);
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_q15_to_q31",result_q31,MAX_BLOCKSIZE);
#endif
...
/*convert q31*/
  ...
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_F32("riscv_q31_to_float",result_f32,MAX_BLOCKSIZE);
#endif
  SET_GPIO_6();
  riscv_q31_to_q7(src_buf_q31,result_q7, MAX_BLOCKSIZE);
  CLR_GPIO_6();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_q31_to_q7",result_q7,MAX_BLOCKSIZE);
#endif  
  SET_GPIO_5();
  riscv_q31_to_q15(src_buf_q31,result_q15, MAX_BLOCKSIZE);
  CLR_GPIO_5();
#ifdef PRINT_OUTPUT
  PRINT_Q("riscv_q31_to_q15",result_q15,MAX_BLOCKSIZE);
#endif
